...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        <div class="form-group">
            ...
            {{ Form::select('estado', array('1' => 'Habilitado','0' => 'Inhabilitado'),$admincalificacion->estado=='1'?'1':'0',['class' => 'form-control']) }}
...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        <div class="form-group">
            ...
            {{ Form::email('email', isset($admincalificacion)?$admincalificacion->email:'', array('class' => 'form-control')) }}
            @if($errors->has('email'))
                <div class="red-text text-darken-2"><i class="fa fa-exclamation-triangle"
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="PERS_varDNI" name="PERS_varDNI">                            
                            @foreach($personas as $persona)
                                @if(isset($admincalificacion))
                                    
                                        @if($admincalificacion->PERS_varDNI==$persona->PERS_varDNI)
