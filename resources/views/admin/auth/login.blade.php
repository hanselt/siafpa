    ...
    <div class="center-vertical">
        <div class="center-content row">
            ...
            <div class="col-md-6 center-margin">
                ...
                <h3 class="text-center pad15B font-black text-transform-upr font-size-23">Administrador</h3>

                <div class="content-box border-top border-red clearfix">
                    <div class="content-box-wrapper row">
                        <form id="login-validation" class="col-md-12" role="form" method="POST" action="{{ url('/admin/login') }}">
                            {{ csrf_field() }}
                            <div id="login-form">
                                <div class="pad20A">
