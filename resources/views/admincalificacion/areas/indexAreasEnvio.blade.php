                ...
                <table class="table" id="MyTable" name="MyTable">
                    ...
                    @foreach($ListaExpedientes as $Ingreso)
                        <tr id="{{$Ingreso->CONT_varHojaTramite}}BG">
                            ...
                            <td>
                                <p class="toExport">Enviar a:</p>   
                                <select id="{{$Ingreso->CONT_varHojaTramite}}SELECT" multiple="">
                                    <option value="Centros Historicos">Centros Historicos</option>
                                    <option value="Qhapaq Ñan">Qhapaq Ñan</option>
                                    <option value="Gestión de Monumentos">Gestión de Monumentos</option>
                            ...
                            <td>
                                ...
                                <a id="{{$Ingreso->CONT_varHojaTramite}}A" href="areas/{{$Ingreso->CONT_varHojaTramite}}/accion.php" alt="Asignar" title="Calificar" onclick="return confirm('Esta calificando el exp {{$Ingreso->CONT_varHojaTramite}}');"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                            </td>
                            <script type="text/javascript">
                                ...
                                $('#{{$Ingreso->CONT_varHojaTramite}}A').on('click',function(e){
                                    ...
                                    var Route="areas/{{$Ingreso->CONT_varHojaTramite}}/";
                                    var DD=Estado;
