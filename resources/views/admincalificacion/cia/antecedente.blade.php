    ...
    <div class="container mrg15T row">
      <div class="col-md-12">
        <div class="content-box" style="background-color:#f5f8fa">
            <h3 class="content-box-header bg-danger" style="background-color:#555456">
                Ingreso de Antecedente
            </h3>
            {{ Form::open(array('url' => 'admincalificacion/crear/ciaantecedente','method','POST')) }}
            @include('admincalificacion.cia.forms.partials.formant')
