...
<div class="row">
    <div class="col-xs-12 col-md-3">
        <div class="form-group">
            ...
            {{ Form::select('CONT_varTipo', array('PEA' => 'PEA','Levantamiento Obs. PEA' =>'Levantamiento Obs. PEA','Reingreso PEA' =>'Reingreso PEA','Otros' =>'Otros'),isset($cir_control)?$cir_control->CONT_varTipo:'Otros',['class' => 'form-control','id'=>'selectTipo']) }}
