...
@section('title', 'Registrar Conservación Preventiva')

@section('breadcrumb')
  <li class="active">Registrar Conservación Preventiva</li>
@endsection
...
<gicpbam-conservacion v-on:mensaje="mostrarMensaje"></gicpbam-conservacion>
@endsection
