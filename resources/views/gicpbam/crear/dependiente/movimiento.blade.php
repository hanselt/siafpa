...
@section('title', 'Registrar Movimiento de Fragmento')

@section('breadcrumb')
  <li class="active">Registrar Movimiento de Fragmento</li>
@endsection

@section('content')
<div class="page-header">
  <h1>Movimiento de Fragmento</h1>
</div>
<!-- Alertas -->
...
<gicpbam-movimiento v-on:mensaje="mostrarMensaje"></gicpbam-movimiento>
@endsection
