...
@section('title', 'Registrar Análisis de Muestras')

@section('breadcrumb')
  <li class="active">Registrar Análisis de Muestras</li>
@endsection

@section('content')
<div class="page-header">
  <h1>Análisis de Muestras</h1>
</div>
<!-- Alertas -->
...
<gicpbam-analisis-muestras v-on:mensaje="mostrarMensaje"></gicpbam-analisis-muestras>
@endsection
