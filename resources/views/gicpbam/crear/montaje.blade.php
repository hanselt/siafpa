...
@section('title', 'Registrar Montaje en Paneles')

@section('breadcrumb')
  <li class="active">Registrar Montaje en Paneles</li>
@endsection

@section('content')
<div class="page-header">
  <h1>Montaje en Paneles</h1>
</div>
<!-- Alertas -->
...
<gicpbam-montaje v-on:mensaje="mostrarMensaje"></gicpbam-montaje>
@endsection
