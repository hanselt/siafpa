...
<div class="container mrg15T row">
    <div class="col-md-12">
        <div class="content-box" style="bordered">
            <h3 class="content-box-header bg-danger" id="tittle">Coordinación de Certificaciones<br>
            Expedientes para enviar al Área Funcional Patrimonio Arqueológico
            </h3>
                ...
                <table class="table" id="MyTable" name="MyTable">
                    ...
                    @foreach($ListaExpedientes as $Ingreso)
                        <tr id="{{$Ingreso->CONT_varHojaTramite}}BG">
                            ...
                            <td>
                                <p style="display: none;" class="toExport">Derivar AFPA</p>   
                                <a href="enviar_Afpa/{{$Ingreso->CONT_varHojaTramite}}" alt="Asignar" title="Enviar AFPA."><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                            </td>
                            <script type="text/javascript">
                                ...
                                var tdFecha2=document.getElementById('{{$Ingreso->CONT_varHojaTramite}}VDAT').innerHTML=listaFecha(FechaAsignacion);
                                ...
                                var tdVenc2=document.getElementById('{{$Ingreso->CONT_varHojaTramite}}VV').innerHTML=listaFecha(FechaVencimiento);
                            </script>
