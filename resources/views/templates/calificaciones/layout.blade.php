  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
      <ul class="nav sidebar-nav">
        ...
        <li class="sidebar-group-title">Calificaciones e Intervenciones</li>
        <li><a href="{{ url('admincalificacion/cargarccia') }}">Cargar CCIA</a></li>
        <li><a href="{{ url('admincalificacion/importarccia') }}">Importar CCIA</a></li>
        <li><a href="{{ url('admincalificacion/ccia') }}">CCIA</a></li>
        <li><a href="{{ url('admincalificacion/ciaproyectos') }}">CIA Proyectos</a></li>
        <li><a href="{{ url('admincalificacion/crear/cia') }}">Crear CIA</a></li>
        <li><a href="{{ url('admincalificacion/pmas') }}">PMAs</a></li>
        <li><a href="{{ url('admincalificacion/cias') }}">CIAs</a></li>
        <li><a href="{{ url('admincalificacion/ver-ccia') }}">Ver CCIA</a></li>
        <li><a href="{{ url('admincalificacion/ver-tiempos') }}">Ver Tiempos</a></li>
        <li><a href="{{ url('admincalificacion/ver-exp') }}">Ver Exp</a></li>
        <li><a href="{{ url('admincalificacion/ver-areas') }}">Ver Áreas</a></li>
        <li><a href="{{ url('admincalificacion/ver-rareas') }}">Ver R Áreas</a></li>
        <li><a href="{{ url('admincalificacion/ver-calificacion') }}">Ver Calificación</a></li>
        <li><a href="{{ url('admincalificacion/ver-abogados') }}">Ver Abogados</a></li>
        <li><a href="{{ url('admincalificacion/ver-observados') }}">Ver Observados</a></li>
        <li><a href="{{ url('admincalificacion/ver-oficiados') }}">Ver Oficiados</a></li>
        <li><a href="{{ url('admincalificacion/recepcionarAbg') }}">Recepcionar Abogado</a></li>
        <li><a href="{{ url('admincalificacion/calificarAbg') }}">Calificar Abogado</a></li>
        <li><a href="{{ url('admincalificacion/recepcionCertificaciones') }}">Recepción Certificaciones</a></li>
        <li><a href="{{ url('admincalificacion/enviar-afpa') }}">Enviar AFPA</a></li>
        <li><a href="{{ url('admincalificacion/crear/ciaantecedente') }}">Crear CIA Antecedente</a></li>
      </ul>
    </nav>
    <!-- /#sidebar-wrapper -->
    <!-- Page Content -->
        ...
        <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb">
              ...
              <li><a href="{{ url('/calificaciones/escritorio') }}">Calificaciones e Intervenciones</a></li>
              @yield('breadcrumb')
            </ol>
            <div id="app">
              @yield('content')
