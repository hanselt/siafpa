...
@section('title', 'Crear Ficha de Inventario')

@section('breadcrumb')
  <li class="active">Crear Ficha de Inventario</li>
@endsection

@section('content')
<div class="page-header">
  <h1>Crear Ficha de Inventario</h1>
</div>
<!-- Alertas -->
...
<!-- /Alertas -->
<gmcpcam-inventario v-on:mensaje="mostrarMensaje"></gmcpcam-inventario>
@endsection
