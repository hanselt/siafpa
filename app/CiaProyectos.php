...
class CiaProyectos extends Model
{
  /**
  ...
  /**
   * Recuperar el análisis bioarqueológico del proyecto.
   */
  ...
  {
    if ($this->PROY_datFechaIngreso) {
      return date('Y', strtotime($this->PROY_datFechaIngreso));
    } else {
      return null;
    }
  }
