...
function convertirFechaString(datein){
    var Dia=datein.getDate();
    var Mes=(datein.getMonth()+1);
    var Anio=datein.getFullYear();
    var sfecha="";
    if(Dia<10){sfecha="0"+Dia+"/";}else{sfecha=Dia+"/";};
    if (Mes<10) {sfecha="0"+Mes+"/";}else{sfecha=sfecha+Mes+"/";};
    sfecha=sfecha+Anio;
...
function esFeriado(dateseacrh)
{
    ...
    var feriados=[feriado1,feriado2];
